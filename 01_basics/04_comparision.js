...
// console.log('2' > '1'); // Is String 2 is greater than string 1 Output True
// console.log('2' >= '1'); // Is String 2 is greater or equal to string 1 Output True
// console.log('2' < '1'); // Is String 2 is smaller than string 1 Output is False
// console.log('2' == '1'); // Is String 2 is equal to string 1 Output is False
// console.log('2' != '1'); // Is String 2 is is not equal to string 1 Output is True.
...
// Comparisions convert null to a number, treating it as 0. Thats why(4) null >= 0 is true and (1) null > 0 is false.
// console.log(null > 0);
// console.log(null < 0);
// console.log(null == 0);
// console.log(null >= 0);
