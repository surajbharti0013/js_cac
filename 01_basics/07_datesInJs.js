...
// console.log(myDate.toDateString()); // Sun Oct 15 2023. The myDate.toDateString() method returns current day,date.

// console.log(myDate.toISOString()); // 2023-10-16T15:31:48.373Z. toISOString() returns a date as string, using the ISO standard.

// console.log(myDate.toJSON()); // 2023-10-16T15:31:48.373Z. toJSON() returns a date as a string, using JSON date formatting.

// console.log(myDate.toLocaleDateString()); // 16/10/2023. toLocaleDateString() returns the date (not the time) of a date, as a string, using locale conventions.

// console.log(myDate.toLocaleString()); // 16/10/2023, 9:01:48 pm. toLocaleString() returns a date as a string, using locale settings.
...
// let myTimeStamp = Date.now(); // Date.now() will return current milli-seconds from 1 Jan 1970.
// console.log(myTimeStamp);

// let newDate = new Date();
// console.log(newDate); // Returns current date month and year but in non readable format.
...
// console.log(newDate.getDay()); // Return current day.
